...
vim.cmd [[
  ...
  \ lua require('user.nvim-bufdel').delete_buffer(<q-args>, '<bang>' == '!')
...
vim.cmd [[
  set iskeyword+=!
  cnoreabbrev <silent> q lua require "user.nvim-bufdel".close_buffer_or_window(false)
  cnoreabbrev <silent> q! lua require "user.nvim-bufdel".close_buffer_or_window(true)
]]
