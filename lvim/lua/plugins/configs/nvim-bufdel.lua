...
vim.cmd [[
  ...
  \ lua require('plugins.configs.nvim-bufdel').delete_buffer(<q-args>, '<bang>' == '!')
...
vim.cmd [[
  set iskeyword+=!
  cnoreabbrev <silent> q lua require "plugins.configs.nvim-bufdel".close_buffer_or_window(false)
  cnoreabbrev <silent> q! lua require "plugins.configs.nvim-bufdel".close_buffer_or_window(true)
]]
